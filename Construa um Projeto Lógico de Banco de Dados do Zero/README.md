...
Desafio do projeto programa Bootcamp Randstad - Análise de Dados

##
Criar Script SQL de um modelo de oficina feita anteriormente no bootcamp.

Primeiro foi feito uma atualização no modelo com mais conhecimento do bootcamp pra comparar o antigo modelo e o novo.

![img](img/modelagem_oficina.PNG)


E no arquivo script_sql_oficina.sql está a criação dos tables, constraints, foreign keys,e relacionamentos.
...
Abaixo está as inserções dos dados das tabelas e por fim as queries para manipular os dados.
